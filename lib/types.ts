// All shared domain types for the AI English app.
// Import from '@/lib/types' or '@/lib/supabase' (both work — supabase re-exports these).
...
export type UserProfile = {
  ...
  drill_ease_threshold: number
  drill_session_length: number
  updated_at: string
}
